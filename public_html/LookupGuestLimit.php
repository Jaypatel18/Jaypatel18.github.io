...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	...
	if (mysqli_num_rows($result) === 0) {
		echo "Combination of your Name and Phone number don't match, please try again with another family member's phone number. If that doesn't work, please contact Hansa Patel/Jay Patel or Bela Patel/Ami Patel to have your phone number added to the RSVP list.";
	} else {
