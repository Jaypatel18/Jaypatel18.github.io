	...
	try {
		...
		if ($pithi_guests > 0 || $ganesh_sthapana_guests >0 || $garba_guests > 0 || $wedding_guests > 0 || $reception_guests > 0) {
			...
			if ($wedding_guests > 0) {
				...
				$body .= "Address: 1002 US-9, Woodbridge Township, NJ 07095<br>";
				$body .= '<span style="font-weight: bold !important">PS: Ceremony followed by a dinner break, then reception.</span></li>';
